...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', nullable: true }),
    __metadata("design:type", String)
], User.prototype, "apple_id", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'text', nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => bookmark_collection_entity_1.BookmarkCollection, (collection) => collection.user),
    __metadata("design:type", Array)
], User.prototype, "bookmark_collections", void 0);
